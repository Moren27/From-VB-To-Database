...
Public MustInherit Class SqlController(Of T)
    ...
    Protected _database As SqlDatabase
    ...
    Protected Overridable Sub InsertParameters(ByRef command As SqlCommand, item As T)
    End Sub

    Protected Overridable Sub UpdateParameters(ByRef command As SqlCommand, item As T)
    End Sub

    Protected Overridable Sub DeleteParameters(ByRef command As SqlCommand, item As T)
    End Sub
    ...
    Public Function Insert(item As T) As Boolean
        ...
        Dim _command As New SqlCommand(_sql)
